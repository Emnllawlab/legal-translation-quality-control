...
法律翻译质量控制是一套公开提供、禁止商用的英中法律翻译与审阅技能，面向处理中国大陆法、普通法法域（包括美国、英国、香港、新加坡等）、条约及混合法域材料的律师和法律团队。
...
2026 年 8 月的三轮真实案件盲测覆盖建设工程和公司登记判决材料：

- 建设工程案件 A：Skill 组 13/14，Control 组 10/14；
- 建设工程案件 B：Skill 组 14/14，Control 组 9/14；
- 公司登记涤除纠纷四案：Skill 组 14/14，Control 组 12/14。

这些结果显示，技能对主体关系、诉讼立场、法院裁判语气、登记/备案和中国法特有法律效果有实际帮助，但不代表普遍准确率，也不能替代律师逐项核对。测试案件原文、脱敏选段、译文和评估文件不随公开技能发布。
