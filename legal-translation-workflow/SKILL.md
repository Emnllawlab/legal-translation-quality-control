...
description: 用于英中法律翻译、审阅和双语核对的翻译工作流，适用于中国大陆法、普通法法域（包括美国、英国、香港、新加坡等）、国际法及混合法域材料。适合处理合同、诉状、判决、法律法规、法律意见、仲裁材料及其他需要控制法律效果、跨法系术语、法源核验或交付质量的法律文件。需要翻译或审阅法律文本时，即使用户没有使用“质量控制”或“工作流”等术语，也应按本技能执行法系识别、法律效果分析和交付前检查。
---
